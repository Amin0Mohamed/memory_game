...
let arr1 = ['fa-anchor','fa-bicycle', 'fa-bolt','fa-cube','fa-diamond'
            ,'fa-plane', 'fa-leaf','fa-bomb',];

//let arr2 = ['fa-anchor','fa-bicycle', 'fa-bolt','fa-cube','fa-diamond','fa-plane', 'fa-leaf','fa-bomb',];

let cardsArray =arr1.concat(arr1);
...
function timer() {
    let minutes = 0;
    let seconds = 0;
    gameInterval = setInterval( ()=> {  ///////arrow
